...
video = cv2.VideoCapture('IMG_6152.mp4')
...
network = cv2.dnn.readNetFromDarknet('custom_test.cfg',
                                     'yolov3_custom_train_1000.weights')
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter('videos/result3.mp4', fourcc, 30,
